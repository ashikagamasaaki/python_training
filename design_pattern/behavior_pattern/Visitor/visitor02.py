"""
Visitor
複数のクラスにまたがった処理（クラスの構造を変化させずに新たに処理を追加する）

・Visitor: Elementにアクセスするための抽象メソッドを定義
・ConcreteVisitor: Visitorを継承したクラス
・Element: Visitorによって訪れられる対象となるクラスのIFを定義
・ConcreteElement: Elementを継承して処理を実装
"""
